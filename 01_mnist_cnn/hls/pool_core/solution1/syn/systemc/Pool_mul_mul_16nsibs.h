...
#ifndef __Pool_mul_mul_16nsibs__HH__
#define __Pool_mul_mul_16nsibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Pool_mul_mul_16nsibs) {
    ...
    SC_CTOR(Pool_mul_mul_16nsibs):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
