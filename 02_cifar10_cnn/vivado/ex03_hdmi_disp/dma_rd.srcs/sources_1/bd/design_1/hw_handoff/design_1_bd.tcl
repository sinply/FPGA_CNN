...
proc create_root_design { parentCell } {
  ...
  set VGA_TIMING_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:VGA_TIMING:1.0 VGA_TIMING_0 ]
...
CONFIG.CONST_VAL {0} \
  ...
  connect_bd_net -net VGA_TIMING_0_po_de [get_bd_pins VGA_TIMING_0/po_de] [get_bd_pins hdmi_tx_0/VGA_DE]
  connect_bd_net -net VGA_TIMING_0_po_h_sync [get_bd_pins VGA_TIMING_0/po_h_sync] [get_bd_pins hdmi_tx_0/VGA_HS]
  connect_bd_net -net VGA_TIMING_0_po_v_sync [get_bd_pins VGA_TIMING_0/po_v_sync] [get_bd_pins hdmi_tx_0/VGA_VS]
  connect_bd_net -net VGA_TIMING_0_po_vga_b [get_bd_pins VGA_TIMING_0/po_vga_b] [get_bd_pins hdmi_tx_0/VGA_B]
  connect_bd_net -net VGA_TIMING_0_po_vga_g [get_bd_pins VGA_TIMING_0/po_vga_g] [get_bd_pins hdmi_tx_0/VGA_G]
  connect_bd_net -net VGA_TIMING_0_po_vga_r [get_bd_pins VGA_TIMING_0/po_vga_r] [get_bd_pins hdmi_tx_0/VGA_R]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins VGA_TIMING_0/sclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins hdmi_tx_0/PXLCLK_I]
  ...
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins VGA_TIMING_0/rst_n] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
...
#  -string -flagsOSRD
preplace port HDMI_CLK_P -pg 1 -y 270 -defaultsOSRD
preplace port DDR -pg 1 -y 170 -defaultsOSRD
preplace port HDMI_D2_N -pg 1 -y 330 -defaultsOSRD
preplace port HDMI_D0_N -pg 1 -y 410 -defaultsOSRD
preplace port HDMI_D1_N -pg 1 -y 370 -defaultsOSRD
preplace port HDMI_D2_P -pg 1 -y 310 -defaultsOSRD
preplace port HDMI_D1_P -pg 1 -y 350 -defaultsOSRD
preplace port HDMI_D0_P -pg 1 -y 390 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 190 -defaultsOSRD
preplace port HDMI_CLK_N -pg 1 -y 290 -defaultsOSRD
preplace portBus hdmi_out_en -pg 1 -y 40 -defaultsOSRD
preplace inst hdmi_tx_0 -pg 1 -lvl 3 -y 340 -defaultsOSRD
preplace inst VGA_TIMING_0 -pg 1 -lvl 2 -y 420 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 3 -y 40 -defaultsOSRD
preplace inst proc_sys_reset_0 -pg 1 -lvl 2 -y 80 -defaultsOSRD
preplace inst clk_wiz_0 -pg 1 -lvl 2 -y 270 -defaultsOSRD
...
preplace netloc hdmi_tx_0_HDMI_D1_N 1 3 1 NJ
preplace netloc hdmi_tx_0_HDMI_D2_P 1 3 1 NJ
preplace netloc clk_wiz_0_locked 1 2 1 N
preplace netloc hdmi_tx_0_HDMI_D1_P 1 3 1 NJ
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 1 280
preplace netloc VGA_TIMING_0_po_vga_b 1 2 1 610
preplace netloc VGA_TIMING_0_po_de 1 2 1 660
preplace netloc VGA_TIMING_0_po_h_sync 1 2 1 630
preplace netloc xlconstant_0_dout 1 3 1 NJ
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ 190 NJ 190 NJ
preplace netloc hdmi_tx_0_HDMI_CLK_N 1 3 1 NJ
preplace netloc clk_wiz_0_clk_out1 1 1 2 290 200 650
preplace netloc VGA_TIMING_0_po_vga_r 1 2 1 650
preplace netloc proc_sys_reset_0_peripheral_reset 1 2 1 660
preplace netloc clk_wiz_0_clk_out2 1 2 1 N
preplace netloc processing_system7_0_FCLK_CLK0 1 1 1 270
preplace netloc hdmi_tx_0_HDMI_D0_N 1 3 1 NJ
preplace netloc hdmi_tx_0_HDMI_CLK_P 1 3 1 NJ
preplace netloc VGA_TIMING_0_po_vga_g 1 2 1 620
preplace netloc VGA_TIMING_0_po_v_sync 1 2 1 640
preplace netloc hdmi_tx_0_HDMI_D0_P 1 3 1 NJ
preplace netloc hdmi_tx_0_HDMI_D2_N 1 3 1 NJ
levelinfo -pg 1 0 140 450 760 880 -top 0 -bot 510
",
}
