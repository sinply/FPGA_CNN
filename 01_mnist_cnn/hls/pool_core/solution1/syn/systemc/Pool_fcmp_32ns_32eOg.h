...
#ifndef __Pool_fcmp_32ns_32eOg__HH__
#define __Pool_fcmp_32ns_32eOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Pool_fcmp_32ns_32eOg) {
    ...
    SC_CTOR(Pool_fcmp_32ns_32eOg):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
