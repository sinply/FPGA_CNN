...
#ifndef __Conv_mul_mul_16nshbi__HH__
#define __Conv_mul_mul_16nshbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Conv_mul_mul_16nshbi) {
    ...
    SC_CTOR(Conv_mul_mul_16nshbi):  ACMP_smul_us_U ("ACMP_smul_us_U") {
