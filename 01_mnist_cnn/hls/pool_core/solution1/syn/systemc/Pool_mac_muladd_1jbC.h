...
#ifndef __Pool_mac_muladd_1jbC__HH__
#define __Pool_mac_muladd_1jbC__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Pool_mac_muladd_1jbC) {
    ...
    SC_CTOR(Pool_mac_muladd_1jbC):  simcore_mac_0_U ("simcore_mac_0_U") {
