...
#ifndef __Conv_mul_32s_8ns_g8j__HH__
#define __Conv_mul_32s_8ns_g8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Conv_mul_32s_8ns_g8j) {
    ...
    SC_CTOR(Conv_mul_32s_8ns_g8j):  ACMP_mul_su_U ("ACMP_mul_su_U") {
