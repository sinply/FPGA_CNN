...
#ifndef __Conv_mul_32s_16nsfYi__HH__
#define __Conv_mul_32s_16nsfYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Conv_mul_32s_16nsfYi) {
    ...
    SC_CTOR(Conv_mul_32s_16nsfYi):  ACMP_mul_su_U ("ACMP_mul_su_U") {
