...
if(!rst)
	...
	begin
		...
		if(enable)
			begin
//				rgbout_en<=1'b1;rgbout_r<=data_rd[23:16];rgbout_g<=data_rd[15:8];rgbout_b<=data_rd[7:0]; //modified by sinply
				rgbout_en<=1'b1;rgbout_r<=8'h00;rgbout_g<=8'hff;rgbout_b<=8'h00;
			end
		else
			begin
