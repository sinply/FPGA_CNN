...
#ifndef __Pool_mul_mul_16s_g8j__HH__
#define __Pool_mul_mul_16s_g8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Pool_mul_mul_16s_g8j) {
    ...
    SC_CTOR(Pool_mul_mul_16s_g8j):  ACMP_smul_su_U ("ACMP_smul_su_U") {
