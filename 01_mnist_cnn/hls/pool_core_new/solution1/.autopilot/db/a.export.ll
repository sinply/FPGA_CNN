; ModuleID = 'E:/Exercise/FPGA/FPGA_CNN/01_mnist_cnn/hls/pool_core_new/solution1/.autopilot/db/a.o.2.bc'
...
define void @Pool(float* %gmem, i16 %CHin_V, i16 %Hin_V, i16 %Win_V, i8 %Kx_V, i8 %Ky_V, i2 %mode_V, i32 %feature_in, i32 %feature_out) {
  ...
  %tmp_7 = zext i30 %feature_in1 to i32
  call void (...)* @_ssdm_op_SpecBitsMap(float* %gmem), !map !91
  call void (...)* @_ssdm_op_SpecBitsMap(i16 %CHin_V), !map !96
  call void (...)* @_ssdm_op_SpecBitsMap(i16 %Hin_V), !map !102
  call void (...)* @_ssdm_op_SpecBitsMap(i16 %Win_V), !map !106
  call void (...)* @_ssdm_op_SpecBitsMap(i8 %Kx_V), !map !110
  call void (...)* @_ssdm_op_SpecBitsMap(i8 %Ky_V), !map !114
  call void (...)* @_ssdm_op_SpecBitsMap(i2 %mode_V), !map !118
  ...
  %r_V = udiv i16 %Win_V_read, %lhs_V
  %rhs_V = zext i8 %Ky_V_read to i16
  %r_V_1 = udiv i16 %Hin_V_read, %rhs_V
  %tmp_5 = zext i16 %r_V_1 to i32
  %tmp_6 = zext i16 %r_V to i32
  %tmp_2 = icmp eq i2 %mode_V_read, 0
  %tmp_1 = zext i16 %Win_V_read to i32
  %rhs_V_1 = zext i16 %Hin_V_read to i32
  %r_V_2 = mul i16 %lhs_V, %rhs_V
  %tmp_s = zext i16 %r_V_2 to i32
  %tmp_3 = sitofp i32 %tmp_s to float
  %tmp_4 = icmp eq i2 %mode_V_read, 1
  %sum = select i1 %tmp_2, float 0.000000e+00, float 0x4376345780000000
  %tmp_9 = or i1 %tmp_2, %tmp_4
  %p_sum = select i1 %tmp_9, float %sum, float 0xC376345780000000
  br label %.loopexit
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %0
  %op_assign = phi i16 [ 0, %0 ], [ %c, %.loopexit.loopexit ]
  %phi_mul1 = phi i32 [ 0, %0 ], [ %next_mul2, %.loopexit.loopexit ]
  %phi_mul2 = phi i32 [ 0, %0 ], [ %next_mul1, %.loopexit.loopexit ]
  %next_mul1 = add i32 %phi_mul2, %tmp_1
  %next_mul2 = add i32 %phi_mul1, %tmp_6
  %exitcond4 = icmp eq i16 %op_assign, %CHin_V_read
  %empty = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 0, i64 65535, i64 0)
  %c = add i16 %op_assign, 1
  br i1 %exitcond4, label %8, label %.preheader1017.preheader

.preheader1017.preheader:                         ; preds = %.loopexit
  br label %.preheader1017

.preheader1017:                                   ; preds = %.preheader1017.preheader, %7
  %i_op_assign_s = phi i16 [ %i, %7 ], [ 0, %.preheader1017.preheader ]
  %phi_mul9 = phi i16 [ %next_mul3, %7 ], [ 0, %.preheader1017.preheader ]
  %next_mul3 = add i16 %phi_mul9, %rhs_V
  %i_op_assign_13_cast4 = zext i16 %i_op_assign_s to i32
  %exitcond1 = icmp eq i16 %i_op_assign_s, %r_V
  %empty_6 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 0, i64 65535, i64 0)
  %i = add i16 %i_op_assign_s, 1
  br i1 %exitcond1, label %.loopexit.loopexit, label %.preheader1016.preheader

.preheader1016.preheader:                         ; preds = %.preheader1017
  %tmp = add i32 %i_op_assign_13_cast4, %phi_mul1
  %tmp1 = mul i32 %tmp, %tmp_5
  %feature_out4_sum = add i32 %tmp_8, %tmp1
  %gmem_addr = getelementptr inbounds float* %gmem, i32 %feature_out4_sum
  %gmem_addr_wr_req = call i1 @_ssdm_op_WriteReq.m_axi.floatP(float* %gmem_addr, i32 %tmp_5)
  br label %.preheader1016

.preheader1016:                                   ; preds = %._crit_edge1022, %.preheader1016.preheader
  %i_op_assign_1 = phi i16 [ %j, %._crit_edge1022 ], [ 0, %.preheader1016.preheader ]
  %phi_mul = phi i16 [ %next_mul, %._crit_edge1022 ], [ 0, %.preheader1016.preheader ]
  %next_mul = add i16 %phi_mul, %lhs_V
  %exitcond = icmp eq i16 %i_op_assign_1, %r_V_1
  %empty_7 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 0, i64 65535, i64 0)
  %j = add i16 %i_op_assign_1, 1
  br i1 %exitcond, label %7, label %.preheader1015.preheader
...
.preheader1015:                                   ; preds = %.preheader1015.preheader, %.preheader1015.loopexit
  %i_op_assign = phi float [ %sum_3, %.preheader1015.loopexit ], [ %p_sum, %.preheader1015.preheader ]
  %i_op_assign_2 = phi i8 [ %ii, %.preheader1015.loopexit ], [ 0, %.preheader1015.preheader ]
  %exitcond2 = icmp eq i8 %i_op_assign_2, %Kx_V_read
...
.preheader.preheader:                             ; preds = %.preheader1015
  ...
  %w_V = add i16 %tmp_10, %phi_mul9
  %lhs_V_1 = sext i16 %w_V to i32
  %r_V3 = add i32 %phi_mul2, %lhs_V_1
  %tmp_11 = mul i32 %r_V3, %rhs_V_1
  br label %.preheader
...
.preheader:                                       ; preds = %.preheader.backedge, %.preheader.preheader
  ...
  br i1 %exitcond3, label %.preheader1015.loopexit, label %1

; <label>:1                                       ; preds = %.preheader
  %tmp_12 = zext i8 %i_op_assign_3 to i16
  %h_V = add i16 %phi_mul, %tmp_12
...
; <label>:2                                       ; preds = %1
  %tmp_13 = sext i16 %h_V to i32
  %tmp_14 = add i32 %tmp_11, %tmp_13
  %feature_in2_sum6 = add i32 %tmp_7, %tmp_14
...
; <label>:3                                       ; preds = %1
  %tmp_15 = sext i16 %h_V to i32
  %tmp_16 = add i32 %tmp_11, %tmp_15
  %feature_in2_sum5 = add i32 %tmp_16, %tmp_7
  ...
  %notlhs9 = icmp ne i8 %tmp_17, -1
  %notrhs1 = icmp eq i23 %tmp_18, 0
  %tmp_21 = or i1 %notrhs1, %notlhs9
  %notlhs1 = icmp ne i8 %tmp_19, -1
  %notrhs2 = icmp eq i23 %tmp_20, 0
  %tmp_22 = or i1 %notrhs2, %notlhs1
  %tmp_23 = and i1 %tmp_21, %tmp_22
  %tmp_24 = fcmp ogt float %sum_3, %gmem_addr_2_read
  %tmp_25 = and i1 %tmp_23, %tmp_24
  %feature_in_load_1_su = select i1 %tmp_25, float %gmem_addr_2_read, float %sum_3
  br label %.preheader.backedge

; <label>:4                                       ; preds = %1
  %tmp_26 = sext i16 %h_V to i32
  %tmp_27 = add i32 %tmp_11, %tmp_26
  %feature_in2_sum = add i32 %tmp_27, %tmp_7
  ...
  %sum_3_to_int6 = bitcast float %sum_3 to i32
  %tmp_28 = call i8 @_ssdm_op_PartSelect.i8.i32.i32.i32(i32 %sum_3_to_int6, i32 23, i32 30)
  %tmp_29 = trunc i32 %sum_3_to_int6 to i23
  %feature_in_load_2_to = bitcast float %gmem_addr_3_read to i32
  %tmp_30 = call i8 @_ssdm_op_PartSelect.i8.i32.i32.i32(i32 %feature_in_load_2_to, i32 23, i32 30)
  %tmp_31 = trunc i32 %feature_in_load_2_to to i23
  %notlhs = icmp ne i8 %tmp_28, -1
  %notrhs = icmp eq i23 %tmp_29, 0
  %tmp_32 = or i1 %notrhs, %notlhs
  %notlhs7 = icmp ne i8 %tmp_30, -1
  %notrhs8 = icmp eq i23 %tmp_31, 0
  %tmp_33 = or i1 %notrhs8, %notlhs7
  %tmp_34 = and i1 %tmp_32, %tmp_33
  %tmp_35 = fcmp ogt float %sum_3, %gmem_addr_3_read
  %tmp_36 = and i1 %tmp_34, %tmp_35
  %sum_3_feature_in_loa = select i1 %tmp_36, float %sum_3, float %gmem_addr_3_read
  br label %.preheader.backedge
...
; <label>:5                                       ; preds = %.preheader1015
  br i1 %tmp_2, label %6, label %._crit_edge1022

; <label>:6                                       ; preds = %5
  %sum_1 = fdiv float %i_op_assign, %tmp_3
...
; <label>:7                                       ; preds = %.preheader1016
  %gmem_addr_wr_resp = call i1 @_ssdm_op_WriteResp.m_axi.floatP(float* %gmem_addr)
  br label %.preheader1017
...
!94 = metadata !{metadata !"feature_in", metadata !86, metadata !"float", i32 0, i32 31}
!95 = metadata !{metadata !"feature_out", metadata !86, metadata !"float", i32 0, i32 31}
!96 = metadata !{metadata !97}
!97 = metadata !{i32 0, i32 15, metadata !98}
!98 = metadata !{metadata !99}
!99 = metadata !{metadata !"CHin.V", metadata !100, metadata !"uint16", i32 0, i32 15}
!100 = metadata !{metadata !101}
!101 = metadata !{i32 0, i32 0, i32 0}
!102 = metadata !{metadata !103}
!103 = metadata !{i32 0, i32 15, metadata !104}
!104 = metadata !{metadata !105}
!105 = metadata !{metadata !"Hin.V", metadata !100, metadata !"uint16", i32 0, i32 15}
!106 = metadata !{metadata !107}
!107 = metadata !{i32 0, i32 15, metadata !108}
!108 = metadata !{metadata !109}
!109 = metadata !{metadata !"Win.V", metadata !100, metadata !"uint16", i32 0, i32 15}
!110 = metadata !{metadata !111}
!111 = metadata !{i32 0, i32 7, metadata !112}
!112 = metadata !{metadata !113}
!113 = metadata !{metadata !"Kx.V", metadata !100, metadata !"uint8", i32 0, i32 7}
!114 = metadata !{metadata !115}
!115 = metadata !{i32 0, i32 7, metadata !116}
!116 = metadata !{metadata !117}
!117 = metadata !{metadata !"Ky.V", metadata !100, metadata !"uint8", i32 0, i32 7}
!118 = metadata !{metadata !119}
!119 = metadata !{i32 0, i32 1, metadata !120}
!120 = metadata !{metadata !121}
!121 = metadata !{metadata !"mode.V", metadata !100, metadata !"uint2", i32 0, i32 1}
