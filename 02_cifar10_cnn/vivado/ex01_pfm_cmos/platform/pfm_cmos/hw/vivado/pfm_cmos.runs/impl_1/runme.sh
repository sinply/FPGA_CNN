...
HD_PWD='E:/Exercise/FPGA/FPGA_CNN/02_cifar10_cnn/vivado/ex01_pfm_cmos/hw/pfm_cmos.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pfm_cmos_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pfm_cmos_wrapper.tcl -notrace
