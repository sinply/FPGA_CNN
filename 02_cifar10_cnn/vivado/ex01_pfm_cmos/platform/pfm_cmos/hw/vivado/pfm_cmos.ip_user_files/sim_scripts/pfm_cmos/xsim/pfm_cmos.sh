...
xv_path="D:/ProgramData/Xilinx/SDx/2016.4/Vivado"
...
{
  file="xsim.ini"
  lib_map_path="D:/ProgramData/Xilinx/SDx/2016.4/Vivado/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
map_local_libs()
{
  ...
  local_libs=(xil_defaultlib lib_pkg_v1_0 lib_srl_fifo_v1_0 axi_master_burst_v2_0)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb pfm_cmos.wdb xsim.dir)
