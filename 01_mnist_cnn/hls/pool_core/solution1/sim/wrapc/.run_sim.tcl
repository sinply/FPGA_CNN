...
set ::env(PATH) "$::env(PATH);D:/ProgramData/Xilinx/SDx/2016.4/Vivado_HLS/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);D:/ProgramData/Xilinx/SDx/2016.4/Vivado_HLS/win64/tools/opencv"
set ::env(PATH) "$::env(PATH);D:/ProgramData/Xilinx/SDx/2016.4/Vivado_HLS/win64/tools/fft_v9_0"
set ::env(PATH) "$::env(PATH);D:/ProgramData/Xilinx/SDx/2016.4/Vivado_HLS/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);D:/ProgramData/Xilinx/SDx/2016.4/Vivado_HLS/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "Pool.autotvin.dat"
	set constFileTvOut       "Pool.autotvout.dat"
	set constFileHdlTvIn     "Pool.autohdltvin.dat"
	set constFileHdlTvOut    "Pool.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
